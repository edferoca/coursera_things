...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Peliculas.add(new Pelicula("el dia despues de mañana", "este señor que no se como se llama"));
		...
		Series.add(new Serie("Lie To me", "este señor que no se como se llama"));
		...
		int AñoReciente=0;
		for(int i=0; i<=4 ;i++) {
			if(Peliculas.get(i).getAño() >AñoReciente){
				peliculaMasReciente=i;
				AñoReciente=Peliculas.get(i).getAño();
			}
		}
